    ...
    async def _handle_message(
        ...
        *,
        ...
        if not is_thread and not isinstance(message.channel, discord.DMChannel):
            ...
            # free_response_channels only waives the mention gate above. It must
            # not suppress auto-threading; no_thread_channels is the explicit
            # routing control for parent-channel inline replies.
