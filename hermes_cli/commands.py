...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("branch", "Branch the current session (explore a different path); --thread forks into a new platform thread", "Session",
               aliases=("fork",), args_hint="[--thread] [name]"),
